...
├≽️Perintah: !yt [link]
├≽️Contoh: !yt https://youtu.be/xxxx
├──────────────
├──────────────
├───≽️「 *5.FITUR QUOTES* 」
...
├──────────────
├──────────────
├≽️Follow akun instagram mamanx yang Gans ${instagramlu}
├──────────────
...
├──────────────
├≽️♻️ _JANGAN LUPA BAHAGIA♥_
├──────────────
├≽️♻️ Mau pasang iklan di *${BotName} ?*
├≽️☎️ WA : *${whatsapplu}*
├──────────────
├≽️⚠️ Gunakan dengan bijak(Jan Spam ajg) ‼️
